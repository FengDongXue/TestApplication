            ...
            public void onGestureCodeInput(final String inputCode) {
                ...
                if (mIsFirstInput) {
                    ...
                    if (inputCode.equals(mFirstPassword)) {
                        ...
                        Toast.makeText(MainActivity.this, mFirstPassword, Toast.LENGTH_SHORT).show();
                        mGestureContentView.clearDrawlineState(0L);
                        SharedPreferencesUtil.savaInt(MainActivity.this, "failCount", 5);
                        SharedPreferencesUtil.saveBoolean(MainActivity.this, "isLock", true);         //保存是否加锁
                        SharedPreferencesUtil.saveString(MainActivity.this, "lockkey", mFirstPassword);   //保存手势密码

                        startActivity(new Intent(MainActivity.this,Gesture_Vertify_Activity.class));
                        finish();
                    } else {
