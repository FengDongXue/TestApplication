...
public class WheelView extends View {
	...
	private int[] SHADOWS_COLORS = new int[] { 0xFeFFFFFF,
			0xddFFFFFF, 0x00FFFFFF };
	//
//	private int[] SHADOWS_COLORS = new int[] { 0xefFFFFFF,
//			0xcfFFFFFF, 0x1fFFFFFF };
	...
	private void drawShadows(Canvas canvas) {
		...
		//*/
		//阴影区域的高度
		int height = (int)(3.8 * getItemHeight());
		//*/
	...
	private void drawCenterRect(Canvas canvas) {
		...
		paint.setColor(getResources().getColor(R.color.button_disabled));
		// 设置线宽
		paint.setStrokeWidth((float) 2);
		// 绘制上边直线
		canvas.drawLine(0, center - offset-10, getWidth(), center - offset-10, paint);
		// 绘制下边直线
