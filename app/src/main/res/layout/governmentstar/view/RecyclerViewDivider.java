...
public class RecyclerViewDivider extends RecyclerView.ItemDecoration {
    ...
    private Paint mPaint;
     ...
     private static final int[] ATTRS = new int[]{android.R.attr.listDivider};
       ...
       */
              public RecyclerViewDivider(Context context, int orientation, int drawableId) {this(context, orientation);
                 mDivider = ContextCompat.getDrawable(context, drawableId);mDividerHeight = mDivider.getIntrinsicHeight();
             }
