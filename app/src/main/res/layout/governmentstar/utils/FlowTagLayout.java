...
//            TagAdapter.RemoveListner removeListner = new TagAdapter.RemoveListner() {
//                @Override
//                public void setRemListner() {
//
//                }
//            };
            ...
            childView.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mTagCheckMode == FLOW_TAG_CHECKED_NONE) {        //选择   默认的
                        if (mOnTagClickListener != null) {
                            mOnTagClickListener.onItemClick(FlowTagLayout.this, childView, j);
                        }
                    } else if (mTagCheckMode == FLOW_TAG_CHECKED_SINGLE) {      //单选
                        //判断状态
                    ...
                    } else if (mTagCheckMode == FLOW_TAG_CHECKED_MULTI) {      //多选
                        if (mCheckedTagArray.get(j)) {
                            mCheckedTagArray.put(j, false);
