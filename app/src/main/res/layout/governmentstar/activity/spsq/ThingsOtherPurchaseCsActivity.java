...
public class ThingsOtherPurchaseCsActivity extends ApplyBaseActivity implements View.OnClickListener {
    ...
    private void getData() {
        ...
        rlPersonCs.setVisibility(View.GONE);        //抄送人
