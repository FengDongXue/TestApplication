...
public class SpsqDetailsFlowAdapter extends BaseAdapter {
    List<SpsqQjApplyDetails.DataBean> dataBeanList;
    Context context;
    LayoutInflater inflater = null;

    public SpsqDetailsFlowAdapter(List<SpsqQjApplyDetails.DataBean> dataBeanList, Context context) {
        this.dataBeanList = dataBeanList;
        for(int i=Integer.parseInt(dataBeanList.get(dataBeanList.size()-1).getOpstate()) ;i<3 ;i++){
            dataBeanList.add(new SpsqQjApplyDetails.DataBean("","",i+1,""+(i+1),"","",""));
        }
