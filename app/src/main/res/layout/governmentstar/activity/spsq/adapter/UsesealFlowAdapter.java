...
public class UsesealFlowAdapter extends BaseAdapter {
    List<SpsqSealApplyDetails.DataBean> dataBeanList;
    Context context;
    LayoutInflater inflater = null;

    public UsesealFlowAdapter(List<SpsqSealApplyDetails.DataBean> dataBeanList, Context context) {
        this.dataBeanList = dataBeanList;
        for(int i=Integer.parseInt(dataBeanList.get(dataBeanList.size()-1).getOpstate()) ;i<3 ;i++){
            dataBeanList.add(new SpsqSealApplyDetails.DataBean("","",i+1,""+(i+1),"","",""));
        }
        ...
        vto.addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
            ...
            public boolean onPreDraw() {
                ...
                if (i == 0) {//首页
                    ...
                    Log.e("首页","感豆腐干豆腐干梵蒂冈梵蒂冈");
                } else {
                    Log.e("尾页2222","感豆腐干豆腐干梵蒂冈梵蒂冈");
                    holder.adapter_document_line2.setVisibility(View.VISIBLE);
