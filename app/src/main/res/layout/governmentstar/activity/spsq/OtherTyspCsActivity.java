...
public class OtherTyspCsActivity extends ApplyBaseActivity implements View.OnClickListener {
    ...
    protected int getLayoutResId() {
        return R.layout.cs_applylicense;
    }
...
//        apply_details.setVisibility(View.VISIBLE);
...
//        flow2.setOnClickListener(this);
        ...
        rlPersonCs.setVisibility(View.GONE);  //隐藏抄送人
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.enlarge:
                ...
                Log.e("amplifyamplifyamplify","amplifyamplifyamplify");
                break;
            ...
            case R.id.enshrink:
                ...
                Log.e("narrownarrownarrow","narrownarrownarrow");
                break;
        }
    }
    ...
    private void getdata() {
        ...
        RetrofitHelper.getInstance().spsqCKxx(opId, userId, "spsqCKxx", new CallBackYSAdapter() {
            @Override
            ...
            protected void parseJson(String data) {
                ...
                if (data != null) {
                    ...
                    Glide.with(OtherTyspCsActivity.this)
                            .load(personImage)
                            .into(pic_head);
                    ...
                    if (spsqQTApplyDetails.getFiles() == null | spsqQTApplyDetails.getFiles().size() <= 0) {
                        ...
                        adapter = new FilesQTAdapter(OtherTyspCsActivity.this,spsqQTApplyDetails.getFiles());
                        rv_fjname.setLayoutManager(new LinearLayoutManager(OtherTyspCsActivity.this, LinearLayoutManager.VERTICAL, false));   //为recyclerView指定现行垂直布局
                    ...
                    if (spsqQTApplyDetails.getData() == null | spsqQTApplyDetails.getData().size() <= 0) {
                        ...
                        flowAdapter = new OutQJFlowAdapter(spsqQTApplyDetails.getData(), OtherTyspCsActivity.this);
