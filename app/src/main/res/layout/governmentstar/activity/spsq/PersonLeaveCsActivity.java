...
public class PersonLeaveCsActivity extends ApplyBaseActivity implements View.OnClickListener {
    ...
    private void getData() {
        ...
        NameStartTime.setText("入职日期");
        NameReturnTime.setText("离职日期");
        NameReceive.setText("交接事项");
