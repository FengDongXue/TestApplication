...
public class ThingsPurchaseApplyCsActivity extends ApplyBaseActivity implements View.OnClickListener {
        ...
        RetrofitHelper.getInstance().spsqCKxx(opId, userId, "spsqCKxx", new CallBackYSAdapter() {
            ...
            protected void parseJson(String data) {
                ...
                if (data != null) {
                    ...
                    Glide.with(ThingsPurchaseApplyCsActivity.this)
                            .load(personImage)
                            .into(pic_head);
                    ...
                    if (spsqThingsApplyDetails.getFiles() == null | spsqThingsApplyDetails.getFiles().size() <= 0) {
                        ...
                        adapter = new FilesThingsSgAdapter(ThingsPurchaseApplyCsActivity.this, spsqThingsApplyDetails.getFiles());
                        rv_fjname.setLayoutManager(new LinearLayoutManager(ThingsPurchaseApplyCsActivity.this, LinearLayoutManager.VERTICAL, false));   //为recyclerView指定现行垂直布局
                    ...
                    if (spsqThingsApplyDetails.getData() == null | spsqThingsApplyDetails.getData().size() <= 0) {
                        ...
                        flowAdapter = new ThingsPurchaseFlowAdapter(spsqThingsApplyDetails.getData(), ThingsPurchaseApplyCsActivity.this);
