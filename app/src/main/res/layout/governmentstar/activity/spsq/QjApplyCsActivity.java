...
public class QjApplyCsActivity extends ApplyBaseActivity implements View.OnClickListener {
        ...
        RetrofitHelper.getInstance().spsqCKxx(opId, userId, "spsqCKxx", new CallBackYSAdapter() {
            ...
            protected void parseJson(String data) {
                ...
                if (data != null) {
                    ...
                    Glide.with(QjApplyCsActivity.this)
                            .load(personImage)
                            .into(pic_head);
                    ...
                    picAdapter = new PicAdapter(QjApplyCsActivity.this, spsqQjApplyDetails.getImgfiles());
                    ...
                    if (spsqQjApplyDetails.getFiles() == null | spsqQjApplyDetails.getFiles().size() <= 0) {
                        ...
                        adapter = new FilesQjAdapter(QjApplyCsActivity.this, spsqQjApplyDetails.getFiles());
                        rv_fjname.setLayoutManager(new LinearLayoutManager(QjApplyCsActivity.this, LinearLayoutManager.VERTICAL, false){
                            @Override
                            public boolean canScrollVertically() {
                                return false;
                            }
                    ...
                    if (spsqQjApplyDetails.getData() == null | spsqQjApplyDetails.getData().size() <= 0) {
                        ...
                        flowAdapter = new SpsqDetailsFlowAdapter(spsqQjApplyDetails.getData(), QjApplyCsActivity.this);
