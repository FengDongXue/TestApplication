...
public class FilesOutPublicAdapter extends RecyclerView.Adapter<FilesOutPublicAdapter.MyViewHolder> {

    private List<SpsqOutApplyDetails.FilesBean> fileList;
    ...
    public FilesOutPublicAdapter(Activity activity, List<SpsqOutApplyDetails.FilesBean> fileList) {
...
//                Log.e("附件", filePreview);
                ...
                if (path.contains(".jpg")
                    ...
                    if (FileUtils.checkFileExists(path_addtion)) {
                        ...
                        new DialogUtil(activity,  new FilesOutPublicAdapter.Summit(fileList)).showConfirm("下载提示", "确定要下载到本地嘛？", "确定", "不用了");
                    }
                }
            }
        });
    ...
    class Summit implements DialogUtil.OnClickListenner {
        ...
        private List<SpsqOutApplyDetails.FilesBean> data;

        public Summit(List<SpsqOutApplyDetails.FilesBean> fileList) {
            this.data = fileList;
        }
