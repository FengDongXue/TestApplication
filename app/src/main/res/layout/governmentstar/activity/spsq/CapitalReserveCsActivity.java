...
public class CapitalReserveCsActivity extends ApplyBaseActivity implements View.OnClickListener {
    ...
    private void getData() {
        ...
        nameInstructsp.setText("用途事由");
        nameBtime.setText("借资日期");
