...
public class OutReimburseCsActivity extends ApplyBaseActivity implements View.OnClickListener {
    ...
    private void getData() {
        ...
        nameInstructsp.setText("外出事由");
        namePlace.setText("出差地点");
