...
public class FilesThingsSgAdapter extends RecyclerView.Adapter<FilesThingsSgAdapter.MyViewHolder> {

    private List<SpsqThingsApplyDetails.FilesBean> fileList;
    ...
    public FilesThingsSgAdapter(Activity activity, List<SpsqThingsApplyDetails.FilesBean> fileList) {
...
//                Log.e("附件", filePreview);
                ...
                if (path.contains(".jpg")
                    ...
                    if (FileUtils.checkFileExists(path_addtion)) {
                        ...
                        new DialogUtil(activity,  new FilesThingsSgAdapter.Summit(fileList)).showConfirm("下载提示", "确定要下载到本地嘛？", "确定", "不用了");
                    }
                }
            }
        });
    ...
    class Summit implements DialogUtil.OnClickListenner {
        ...
        private List<SpsqThingsApplyDetails.FilesBean> data;

        public Summit(List<SpsqThingsApplyDetails.FilesBean> fileList) {
            this.data = fileList;
        }
