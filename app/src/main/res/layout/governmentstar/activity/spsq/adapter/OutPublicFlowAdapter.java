...
public class OutPublicFlowAdapter extends BaseAdapter {
    List<SpsqOutApplyDetails.DataBean> dataBeanList;
    Context context;
    LayoutInflater inflater = null;

    public OutPublicFlowAdapter(List<SpsqOutApplyDetails.DataBean> dataBeanList, Context context) {
        this.dataBeanList = dataBeanList;
        for(int i=Integer.parseInt(dataBeanList.get(dataBeanList.size()-1).getOpstate()) ;i<3 ;i++){
            dataBeanList.add(new SpsqOutApplyDetails.DataBean("","",i+1,""+(i+1),"","",""));
        }
