...
public class ProjectCsActivity extends ApplyBaseActivity implements View.OnClickListener {
    ...
    private void getData() {
        ...
        nameInstructsp.setText("预期目标");
        NameReceive.setText("计划进度");
        nameJf.setText("期望启动日期");
