...
public class ThingsPurchaseFlowAdapter extends BaseAdapter {
    List<SpsqThingsApplyDetails.DataBean> dataBeanList;
    Context context;
    LayoutInflater inflater = null;

    public ThingsPurchaseFlowAdapter(List<SpsqThingsApplyDetails.DataBean> dataBeanList, Context context) {
        this.dataBeanList = dataBeanList;
        for(int i=Integer.parseInt(dataBeanList.get(dataBeanList.size()-1).getOpstate()) ;i<3 ;i++){
            dataBeanList.add(new SpsqThingsApplyDetails.DataBean("","",""+(i+1),"","",""));
        }
