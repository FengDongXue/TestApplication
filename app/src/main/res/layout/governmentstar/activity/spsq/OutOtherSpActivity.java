...
public class OutOtherSpActivity extends ApplyBaseActivity implements View.OnClickListener {
...
//        llNumsp.setVisibility(View.GONE);               //申请编号
//        llDatesp.setVisibility(View.GONE);        //申请日期
//        llThingsType.setVisibility(View.GONE);        //物品类型
//        llThingsReceive.setVisibility(View.GONE);          //领用物品
