...
public class OutPublicCsActivity extends ApplyBaseActivity implements View.OnClickListener {
        ...
        RetrofitHelper.getInstance().spsqCKxx(opId, userId, "spsqCKxx", new CallBackYSAdapter() {
            ...
            protected void parseJson(String data) {
                ...
                if (data != null) {
                    ...
                    Glide.with(OutPublicCsActivity.this)
                            .load(personImage)
                            .into(pic_head);
                    ...
                    if (spsqOutApplyDetails.getFiles() == null | spsqOutApplyDetails.getFiles().size() <= 0) {
                        ...
                        adapter = new FilesOutPublicAdapter(OutPublicCsActivity.this, spsqOutApplyDetails.getFiles());
                        rv_fjname.setLayoutManager(new LinearLayoutManager(OutPublicCsActivity.this, LinearLayoutManager.VERTICAL, false));   //为recyclerView指定现行垂直布局
                    ...
                    if (spsqOutApplyDetails.getData() == null | spsqOutApplyDetails.getData().size() <= 0) {
                        ...
                        flowAdapter = new OutPublicFlowAdapter(spsqOutApplyDetails.getData(), OutPublicCsActivity.this);
