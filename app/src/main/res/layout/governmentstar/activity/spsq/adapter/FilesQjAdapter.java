...
public class FilesQjAdapter extends RecyclerView.Adapter<FilesQjAdapter.MyViewHolder> {

    private List<SpsqQjApplyDetails.FilesBean> fileList;
    ...
    public FilesQjAdapter(Activity activity, List<SpsqQjApplyDetails.FilesBean> fileList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new FilesQjAdapter.MyViewHolder(view);
    }
...
//                Log.e("附件", filePreview);
                ...
                if (path.contains(".jpg")
                    ...
                    if (FileUtils.checkFileExists(path_addtion)) {
                        ...
                        new DialogUtil(activity,  new Summit(fileList)).showConfirm("下载提示", "确定要下载到本地嘛？", "确定", "不用了");
                    }
                }
            }
        });
    ...
    class Summit implements DialogUtil.OnClickListenner {
        ...
        private List<SpsqQjApplyDetails.FilesBean> data;

        public Summit(List<SpsqQjApplyDetails.FilesBean> fileList) {
            this.data = fileList;
        }
