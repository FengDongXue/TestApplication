...
public class SealUsesealCsActivity extends ApplyBaseActivity implements View.OnClickListener {
        ...
        RetrofitHelper.getInstance().spsqCKxx(opId, userId, "spsqCKxx", new CallBackYSAdapter() {
            ...
            protected void parseJson(String data) {
                ...
                if (data != null) {
                    ...
                    Glide.with(SealUsesealCsActivity.this)
                            .load(personImage)
                            .into(pic_head);
                    ...
                    if (spsqSealApplyDetails.getFiles() == null | spsqSealApplyDetails.getFiles().size() <= 0) {
                        ...
                        adapter = new FilesUsesealAdapter(SealUsesealCsActivity.this, spsqSealApplyDetails.getFiles());
                        rv_fjname.setLayoutManager(new LinearLayoutManager(SealUsesealCsActivity.this, LinearLayoutManager.VERTICAL, false){
                            @Override
                    ...
                    if (spsqSealApplyDetails.getData() == null | spsqSealApplyDetails.getData().size() <= 0) {
                        ...
                        flowAdapter = new UsesealFlowAdapter(spsqSealApplyDetails.getData(), SealUsesealCsActivity.this);
