...
public class FilesQTAdapter extends RecyclerView.Adapter<FilesQTAdapter.MyViewHolder> {

    private List<SpsqQTApplyDetails.FilesBean> fileList;
    ...
    public FilesQTAdapter(Activity activity, List<SpsqQTApplyDetails.FilesBean> fileList) {
...
//                Log.e("附件", filePreview);
    ...
    class Summit implements DialogUtil.OnClickListenner {
        ...
        private List<SpsqQTApplyDetails.FilesBean> data;

        public Summit(List<SpsqQTApplyDetails.FilesBean> fileList) {
            this.data = fileList;
        }
