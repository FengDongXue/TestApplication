...
public class ChooseReceiverPSActivity extends BaseActivity implements View.OnClickListener {
        ...
        call.enqueue(new Callback<InCirculationTree>() {
            ...
            public void onResponse(Call<InCirculationTree> call, Response<InCirculationTree> response) {
                ...
                if (response.body().getDeptList() == null) {
                    Toast.makeText(ChooseReceiverPSActivity.this, "", Toast.LENGTH_SHORT).show();
                } else {
            ...
            public void onFailure(Call<InCirculationTree> call, Throwable t) {
                Toast.makeText(ChooseReceiverPSActivity.this, t.toString(), Toast.LENGTH_SHORT).show();
